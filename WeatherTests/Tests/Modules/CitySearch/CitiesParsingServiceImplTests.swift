...
final class CitiesParsingServiceImplTests: XCTestCase {
    private var subject: CitiesParsingServiceImpl!
    ...
    override func setUp() {
        ...
        diskFileReader = .init()
        jsonDecoder = .init()
        subject = CitiesParsingServiceImpl(diskFileReader: diskFileReader, jsonDecoder: jsonDecoder)
    }
